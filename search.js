...
const data = [
  { nombre: 'Manual motor', tipoMaestro: 'manuales', tipoSinoptico: 'cliente' },
  { nombre: 'Plano transmision', tipoMaestro: 'planos', tipoSinoptico: 'proveedor' },
  { nombre: 'Reporte seguridad', tipoMaestro: 'reportes', tipoSinoptico: 'interno' },
  { nombre: 'Manual frenos', tipoMaestro: 'manuales', tipoSinoptico: 'proveedor' }
];
