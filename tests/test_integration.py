...
def test_delete_product_blocked_by_relations():
    ...
    db = main.get_db()
    db.execute(
        "INSERT INTO Cliente(codigo,nombre,updated_at) VALUES('C1','A','2024-01-01')"
    )
    db.execute(
        "INSERT INTO Producto(codigo,descripcion,cliente_id,peso,updated_at) VALUES('P1','Prod',1,1,'2024-01-01')"
    )
    db.execute(
        "INSERT INTO Subproducto(producto_id,codigo,peso,updated_at) VALUES(1,'S1',1,'2024-01-01')"
    )
    db.commit()
...
def test_product_activation_cycle():
    ...
    db = main.get_db()
    db.execute(
        "INSERT INTO Cliente(codigo,nombre,updated_at) VALUES('C2','A','2024-01-01')"
    )
    db.execute(
        "INSERT INTO Producto(codigo,descripcion,cliente_id,peso,updated_at,version) VALUES('P2','Prod',1,1,'2024-01-01',1)"
    )
    db.commit()
